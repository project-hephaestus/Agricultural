/** $Id: irrigation_controller.h 4738 2014-07-03 00:55:39Z dchassin $
	Copyright (C) 2009 Battelle Memorial Institute
	@file irrigation_controller.h
	@addtogroup irrigation_controller
	@ingroup market

 **/

#ifndef _irrigation_controller_H
#define _irrigation_controller_H

#include <stdarg.h>
#include "auction.h"
#include "gridlabd.h"

class irrigation_controller : public gld_object {
public:
	int flag;
	complex *y;
	OBJECT *p;
	OBJECT *virtual_battery_object;
	int16 first; //only once in sync
	double *initial_zipload_power;
	double dema;
	double *x;
	double dema2;
	int16 bid_again;
...
private:
	...
	void fetchcop(complex **prop, char *name, OBJECT *parent);
	int dir, direction;
	double min, max;
	double T_lim, k_T;
...
#endif // _irrigation_controller_H
